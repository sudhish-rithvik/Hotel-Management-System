...
class HotelManagementSystem:
    def __init__(self, root):
        self.root = root
        self.root.title("A2S Hotel Management System")
        self.root.geometry("1600x700+0+0")
        self.root.iconbitmap('logohotel.ico')
        ...
        ################ Title ##################
        lbl_title = Label(self.root,text="A2S Hotel Management System",font=("times new roman",40,"bold"),bg="black",fg="gold",bd=4,relief=RIDGE)
        ...
        ################ DOWN IMAGES ####################
        img4 = Image.open("inside.jpg")
        img4 = img4.resize((230,450),Image.ANTIALIAS)
        self.photoimg4=ImageTk.PhotoImage(img4)

        lblimg1 = Label(main_frame,image=self.photoimg4,bd=4,relief=RIDGE)
        lblimg1.place(x=0,y=190,width=228,height=340)

        #img5 = Image.open("inside.jpg")
        #img5 = img5.resize((460,190),Image.ANTIALIAS)
        #self.photoimg5=ImageTk.PhotoImage(img5)

        #lblimg1 = Label(main_frame,image=self.photoimg5,bd=4,relief=RIDGE)
        #lblimg1.place(x=0,y=350,width=228,height=340)

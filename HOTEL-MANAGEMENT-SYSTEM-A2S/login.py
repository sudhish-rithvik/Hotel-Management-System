...
class Login_window:
    def __init__(self,root):
        ...
        img1=Image.open("sagar_icon.png")
        img1=img1.resize((90,90),Image.ANTIALIAS)
        self.photoimage1=ImageTk.PhotoImage(img1)
        lblimg1=Label(image=self.photoimage1,bg="black",borderwidth=0)
        lblimg1.place(x=630,y=170,width=85,height=90)
    ...
    def login(self):
        if self.txtuser.get()=="" or self.txtpass.get()=="":
            ...
            conn = mysql.connector.connect(host="localhost",username="root",password="sagar@123",database="hms")
    ...
    def forgot_password_window(self):
        if self.txtuser.get()=="":
            ...
            if row==None:
                ...
                self.root2.iconbitmap('logohotel.ico')
